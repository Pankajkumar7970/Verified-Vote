      ...
      <div className="flex justify-between items-end border-b pb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage recognized parties assigned to candidates.
          </p>
        </div>
      </div>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewParty({ ...newParty, abbreviation: e.target.value })
                  }
                  placeholder="e.g. NDP"
                />
              </div>
                ...
                <table className="w-full text-left text-sm">
                  <thead className="bg-[#5A5A40]/5 border-b border-[rgba(26,26,26,0.1)]">
                    <tr>
                      ...
                      <th className="p-4 font-semibold text-[#5A5A40]">
                        Abbr.
                      </th>
                      <th className="p-4 font-semibold text-[#5A5A40] text-right">
                        Actions
                      </th>
                    </tr>
                  </thead>
