            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2 bg-[#f5f2ed] border rounded-md focus:outline-none focus:ring-2 uppercase pr-10 ${
                    voterId.length > 0
                      ? isValidFormat
              ...
              <div className="flex gap-3 justify-center">
                {[0, 1, 2, 3, 4, 5].map((index) => (
                  <input
                    ...
                    className={`w-12 h-14 text-center text-xl font-mono border-2 rounded-lg focus:outline-none focus:ring-2 transition-all ${
                      otpError
